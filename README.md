...
<br />
<div align="center">
  <a href="https://github.com/IDElogic">
...
<details>
  ...
  <ol>
    <li>
      <a href="#about-the-project">This is a simple audio player implementation for Android that allows  for anyone who wants to play audio files as a source of background atmospheres.</a>
      <ul>
        <li><a href="#built-with">About the app</a></li>
      </ul>
    </li>
    <li>
...
Create a pull request. Any contributions you make are **greatly appreciated**.
...
Ildiko Csilla Fabian - [@your_twitter](https://twitter.com/your_username) - privat.fi@gmail.com
